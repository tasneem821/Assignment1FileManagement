...
//}
//
//// Function to parse and handle SQL-like queries using regex
...
//    regex selectAllDoctorsRegex(R"(Select all from Doctors where Doctor ID='([^']+)';)");
//    regex selectAllAppointmentsRegex(R"(Select all from Appointments where Doctor ID='([^']+)';)");
//    regex selectDoctorNameRegex(R"(Select Doctor Name from Doctors where Doctor ID='([^']+)';)");
//
//    smatch match;
//
//    if (regex_search(query, match, selectAllDoctorsRegex)) {
//        string doctorId = match[1];
//        handleSelectAllFromDoctors(doctorId, doctorPrimaryIndex);
//    } else if (regex_search(query, match, selectAllAppointmentsRegex)) {
//        string doctorId = match[1];
//        handleSelectAllFromAppointments(doctorId, appointmentSecondaryIndex, primaryIndex);
//    } else if (regex_search(query, match, selectDoctorNameRegex)) {
//        string doctorId = match[1];
...
//       // DoctorPrimaryIndex drdix("doctor_primary_index.txt");
//        Appointment ap1;
...
//        }
//        else if(choice==9){
//           // AppointmentPrimaryIndex appointmentIndex("appointments.idx");
//
//            string query;
